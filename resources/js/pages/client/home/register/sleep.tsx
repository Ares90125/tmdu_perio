        ...
        <div className="w-full">
            <div className="mt-16 mx-8 font-bold bg-bgColor">
                ...
                <div className="my-4">
                    ...
                    <select style={{WebkitAppearance: "none", appearance: "none",textAlignLast: "center",WebkitAlignContent:"center"}} id="fruits" value={selectindex} className="flex items-center justify-center  bg-white text-mainColor  my-2 text-[26px] font-bold w-full rounded-lg border border-mainColor    outline-0 text-center object-center"

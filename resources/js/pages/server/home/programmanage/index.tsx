...
const ProgramManager = () => {
    return (
        <div className='min-h-screen h-full overflow-hidden ml-[60px] flex flex-basis'>
            ...
            <p className="mx-2 text-[24px] hover:text-mainColor sm:py-2 font-content "> プログラムC</p>
                     <NavLink to="programA" className=" px-1">
                        <p className="mx-2 underline hover:text-mainColor sm:py-2 font-content"> プログラムA</p>
                    </NavLink>
                    <NavLink to="programB" className=" px-1">
                        <p className="mx-2 underline hover:text-mainColor sm:py-2 font-content"> プログラムB</p>
                    </NavLink>
                    <NavLink to="programC" className=" px-1">
                        <p className="mx-2 underline hover:text-mainColor sm:py-2 font-content"> プログラムC</p>
                    </NavLink>
                    <NavLink to="programD" className=" px-1">
                        <p className="mx-2 underline hover:text-mainColor sm:py-2 font-content"> プログラムD</p>
                    </NavLink>
            </div>
